...
<div class="container-fluid center" id="form-container">
  {!! Form::model($data, ['method' => 'PUT','route' => ['vehicleSettings', $data->id]]) !!}
  ...
  <div class="text-center">
    ...
    <button type="button" class="btn btn-primary" id="btn-cancel" onclick="location.href='{{route('userVehicles', $data->user_id)}}'">Cancelar</button>
  </div>
</div>
@stop
